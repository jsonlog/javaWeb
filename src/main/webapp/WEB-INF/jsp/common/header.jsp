...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="navbar-header">
        ...
        <a href="${BASE}/welcome" class="navbar-brand"><f:message key="common.title"/></a>
    </div>
    <div class="collapse navbar-collapse" id="navbar">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                <a href="" class="dropdown-toggle" data-toggle="dropdown"><f:message key="common.setting"/> <b class="caret"></b></a>
